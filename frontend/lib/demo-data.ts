...
export const demoJobs: Job[] = [
  { id: "job_001", title_original: "AI Evaluation Specialist", company_name: "Northstar Labs", work_mode: "remote", countries_allowed: ["CN", "SG"], risk_level: "low", risk_score: 0.08, quality_score: 0.94, status: "active", compensation_min: 18, compensation_max: 26, compensation_currency: "USD" },
