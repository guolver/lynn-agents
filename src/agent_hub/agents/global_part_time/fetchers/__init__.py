...
_COUNTRY_ALIASES: dict[str, str] = {
    ...
    "france": "FR", "brazil": "BR", "brasil": "BR", "india": "IN",
    ...
    "portugal": "PT", "ireland": "IE", "poland": "PL", "poland": "PL",
    "czech republic": "CZ", "czechia": "CZ", "romania": "RO",
    "hungary": "HU", "greece": "GR", "turkey": "TR", "türkiye": "TR",
    ...
    "lebanon": "LB", "jordan": "JO", "qatar": "QA",
    "costa rica": "CR", "uruguay": "UY", "ecuador": "EC",
...
_CITY_TO_COUNTRY: dict[str, str] = {
    ...
    "seattle": "US", "austin": "US", "boston": "US", "denver": "US", "miami": "US",
    "atlanta": "US", "dallas": "US", "houston": "US", "portland": "US",
    "alaska": "US", "california": "US", "texas": "US", "florida": "US",
    "london": "GB", "manchester": "GB", "edinburgh": "GB", "bristol": "GB",
    "berlin": "DE", "munich": "DE", "hamburg": "DE", "frankfurt": "DE",
    "paris": "FR", "lyon": "FR", "toronto": "CA", "vancouver": "CA", "montreal": "CA",
    "sydney": "AU", "melbourne": "AU", "brisbane": "AU", "adelaide": "AU", "perth": "AU",
    "tokyo": "JP", "osaka": "JP", "amsterdam": "NL", "dublin": "IE", "lisbon": "PT",
    "barcelona": "ES", "madrid": "ES", "milan": "IT", "rome": "IT",
    "stockholm": "SE", "oslo": "NO", "copenhagen": "DK", "helsinki": "FI",
    "zurich": "CH", "vienna": "AT", "brussels": "BE", "warsaw": "PL",
    ...
    "hyderabad": "IN", "pune": "IN", "chennai": "IN",
    "singapore": "SG", "manila": "PH", "jakarta": "ID", "bangkok": "TH",
    "dubai": "AE", "abu dhabi": "AE", "tel aviv": "IL",
    "buenos aires": "AR", "bogota": "CO", "lima": "PE",
    "mexico city": "MX", "ciudad de méxico": "MX",
    "cape town": "ZA", "johannesburg": "ZA", "lagos": "NG", "nairobi": "KE",
    "cairo": "EG", "istanbul": "TR", "seoul": "KR", "taipei": "TW",
}

_GLOBAL_KEYWORDS = {"worldwide", "global", "anywhere", "remote", "earth", "everywhere"}
_REGION_KEYWORDS = {
    "europe": ["GB", "DE", "FR", "ES", "IT", "NL", "SE", "NO", "DK", "FI",
               "CH", "AT", "BE", "PT", "IE", "PL", "CZ", "RO", "HU", "GR",
               "HR", "RS", "BG", "EE", "LV", "LT", "SK", "SI"],
    "latin america": ["BR", "MX", "AR", "CO", "CL", "PE", "EC", "UY", "CR"],
    "latam": ["BR", "MX", "AR", "CO", "CL", "PE", "EC", "UY", "CR"],
    "asia": ["CN", "JP", "KR", "IN", "SG", "MY", "ID", "TH", "VN", "PH", "TW", "HK"],
    "asia pacific": ["CN", "JP", "KR", "IN", "SG", "MY", "ID", "TH", "VN", "PH", "TW", "HK", "AU", "NZ"],
    "apac": ["CN", "JP", "KR", "IN", "SG", "MY", "ID", "TH", "VN", "PH", "TW", "HK", "AU", "NZ"],
    "north america": ["US", "CA", "MX"],
    "emea": ["GB", "DE", "FR", "ES", "IT", "NL", "SE", "NO", "DK", "FI",
             "CH", "AT", "BE", "PT", "IE", "PL", "EG", "ZA", "NG", "KE", "AE", "SA", "IL"],
}
